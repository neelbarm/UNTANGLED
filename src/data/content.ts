...
export const REEL_IDEAS: ReelIdea[] = [
  ...
  { id: 20, goal: 'Trading', title: 'What a Prop-Firm Evaluation Actually Is', hook: 'People think prop trading is a scam. Here\'s how it really works.', film: 'You explaining the eval/rules structure plainly, on camera.', caption: 'Not hype, not a get-rich scheme. A rules test. Here\'s the reality.' },
